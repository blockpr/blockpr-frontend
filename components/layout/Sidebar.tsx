    ...
    <aside className="w-60 shrink-0 flex flex-col bg-[var(--color-surface)] border-r border-[var(--color-border)]">
      ...
      <div className="h-16 flex items-center px-5 border-b border-[var(--color-border)]">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-[var(--color-text-primary)] tracking-tight">BlockPR</span>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-[var(--color-border)]">
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-danger)] hover:bg-[var(--color-danger-muted)] transition-colors"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
